...
function Get-AzOpsAllSubscription {
    ...
    process {
        ...
        if ($IncludedSubscriptions.count -gt 0) {
        ...
        {
            Write-AzOpsLog -Level Verbose -Topic "Get-AzOpsAllSubscription" -Message "Found [$($IncludedSubscriptions.count)] subscriptions."
        }
